...
<div class="max-w-lg mx-auto">
  ...
  <div class="glass-card p-7">
    <h3 class="text-lg font-bold text-gray-800 mb-1">Add New Room</h3>
    <p class="text-sm text-gray-500 mb-6">Create a new room in the boarding house.</p>

    <form action="insert_room.php" method="POST" class="space-y-4">
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1.5">Room Number</label>
        <input type="text" name="room_number" required placeholder="e.g. A-103"
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="number" min="0" step="0.01" name="rent_price" required
            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-400 text-sm">
        </div>
      </div>
